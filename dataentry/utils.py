    ...
    try:
        ...
        for recipient_email in to_email:
            ...
            if email_id:
                ...
                # Search for the link in the email body
                ...
                open_traking_image = f"<img src='{open_tracking_url}' width='1' height='1'>"
                new_message += open_traking_image
